...
class RingLayer {
  ...
  trigger() {
    this.waveStrength = Phaser.Math.Between(8, 14)
    this.wavePhase = 0
...
export default class BasePlanet {
  constructor(scene, x, y) {
    ...
    // Reactive rings
    this.rings = [
      new RingLayer(82, 88, this.segments),
      new RingLayer(94, 100, this.segments),
      new RingLayer(108, 114, this.segments)
    ]
  ...
  triggerWave() {
    // staggered activation feels more physical
